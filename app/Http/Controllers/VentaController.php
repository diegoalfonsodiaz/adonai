...
class VentaController extends Controller
{
    ...
    public function reportec($id){
        ...
        $pdf::SetXY(187,153);
        $pdf::MultiCell(20,0,"GTQ. ".sprintf("%0.2F", $venta->total_venta-($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,160);
        $pdf::MultiCell(20,0,"GTQ. ".sprintf("%0.2F", ($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,167);
        $pdf::MultiCell(20,0,"GTQ. ".sprintf("%0.2F", $venta->total_venta));
